...
/* DISABLE LZ4 LIB DEPRECATION WARNINGS */
...
public:
	BlockDependentCompressor(int compressionLevel, char* inputBuffer)
		: isHc(compressionLevel >= 3)
		, lz4Ctx(new char[
			isHc ? LZ4_sizeofStateHC()
				: LZ4_sizeofState()
		  ])
		, compressFunction(
			isHc ? LZ4_compressHC_limitedOutput_withStateHC
